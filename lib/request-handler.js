...
// requestHandler.testFunc = function (req, res) {
//   console.log('TESTFUNC REQ ', req.body );
// }
    ...
    return res.sendStatus(400)
        ...
        ///////////////////////////////////////////////////////
          ...
          let transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
              user: 'andrewandrewforesiforesi@gmail.com',
              pass: 'password1212'
            }
          })
        ...
        ///////////////////////////////////////////////////////
          ...
          // let recipient = "foresiandrew@gmail.com"
          ...
          transporter.sendMail(HelperOptions, (error, info) => {
            if(error){
              ...
              new User({email: this.recipient})
                ...
                newAppointmentData.end_date = req.body.start_date;

                console.log('NODEMAILER APPT OBJECT ', newAppointmentData)

                new Appointment(newAppointmentData)
                .save()
                .then(appointment => {
                  console.log('This appointment has been created ', appointment);
                })
...
//   //requestHandler.shareSchedule(req);
// }
...
requestHandler.postSchedule = function (req, res) {
  ...
  console.log('postSchedule body ', req.body);
...
requestHandler.shareSchedule = function (req, res) {
  console.log('Inside requestHandler.shareSchedule');
  let end_date = (req.body.end_date === '') ? req.body.start_date : req.body.end_date;
  ...
  console.log('Appointment data object ', appointment);
  ...
  new Appointment(appointment)
    ...
    .then((newAppointment) => {
      ...
      //     });
      // } else {
        console.log('About to send newAppointment on line 541');
        res.send(newAppointment);
      })
    .catch((err) => {
      console.error(err);
